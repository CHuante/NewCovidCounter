...
function App() {
  ...
  const internationalPage = () => () => {
    state.link = "International Cases";
    dispatch(state);
  }
  ...
  const list = (anchor) => (
    ...
    >
      ...
      <List>
        {['International Cases'].map((text) => (
          <ListItem button dense key={text} onClick={internationalPage(text)} className={classes.root}>
            <ListItemIcon className={classes.icon}>
              <PublicIcon style={{ color: "blue", fontSize: "1rem" }}/>
            </ListItemIcon>
            <ListItemText primary={text} />
          </ListItem>
        ))}
    ...
    <div className="App">
      <AppBar position="static">
        <Toolbar>
          ...
          <Typography variant="h6" className={classes.title}>
            <img src={image2vector} alt="image2vector" />
            a COVID-19 tracker 
          </Typography>
      ...
      {/* Render the home page until click dispatch */}
      {
        ...
        <div className={classes.content}>
          ...
          <h1> United States COVID-19 cases: </h1>
          <iframe src="https://interactives.ap.org/embeds/Ow74t/26/" width="100%" height="700" frameborder="0"></iframe>
          <iframe src="https://public.domo.com/cards/azrGr" width="100%" height="600" marginheight="0" marginwidth="0" frameborder="0"></iframe>
          <iframe src="https://public.domo.com/cards/aAR5B" width="100%" height="700" marginheight="0" marginwidth="0" frameborder="0"></iframe>

          <h2> 
            Data is refreshed daily and collected from 
            <a href = "https://coronavirus.jhu.edu/"> John Hopkins University</a>,
            <a href = "https://covidtracking.com/"> The Covid Tracking Project</a>, 
            as well as <a href = "https://www.domo.com/">DOMO</a>. 
          </h2>       
        </div>
        :
        (state.link === "International Cases")?
        <div className={classes.content}>
          <h1> International COVID-19 cases: </h1>
          <div className={classes.counties}>
          ...
          <h2>Data is refreshed daily and collected from 
            <a href = "https://ourworldindata.org/"> Our World in Data</a>, 
            as well as <a href = "https://www.domo.com/">DOMO</a>.</h2>
        </div>
        :
        (state.currentState)?
          <div className={ classes.content }>
